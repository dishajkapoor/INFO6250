...
<html>
<head>
<title>TurnThePage | Profile</title>
...
<li><a href="controller?action=dashboard" class="tab">Dashboard</a></li>
<li><a href="controller?action=viewmybooks" class="tab">View My Books</a></li>
<li><a href="controller?action=viewbooks" class="tab">View Books</a></li>
    </ul>
    <div class="registration-form">
      <h2>Update Email here</h2>
      <form action="controller?action=updateUsername" method="post">
      ...
      <form action="controller?action=updatePassword" method="post">
      <p id = "status"></p>
